...
set y2label ""   font ""
set yrange [ 14 : 26 ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
...
plot 'ts11.out' using 1:8 title "Anatone" with lines lt 7, 'ts5109.out' using 1:8 title "IHR" with lines lt 5, 'ts539.out' using 1:8 title "LMNW" with lines lt 3, 20 title "" with lines lt 9, 'ts378.out' using 1:8 title "LGSW" with lines lt 4, 'ts33.out' using 1:8 title "LWG" with lines lt 2, 'ts21.out' using 1:8 title "Clearwater-D/S" with lines lt 1 
#    EOF
