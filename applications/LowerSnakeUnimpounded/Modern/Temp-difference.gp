...
set output "Temp-difference.eps"
unset clip points
set clip one
unset clip two
set bar 1.000000
...
set xlabel ""   font ""
set x2label ""   font ""
set xrange [ "05-01-2015 00:00:00" : "10-31-2015 00:00:00" ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "{/Symbol D}T, \312C"   font ""
set y2label ""   font ""
...
plot "<paste ts2015.out ts5109.out" using 1:($8-$25) title "Ice Harbor" with lines lt 1, "<paste ts101.out ts33.out" using 1:($8-$25) title "Lower Granite" with lines lt 3, 0 title "" with lines lt 7
#    EOF
