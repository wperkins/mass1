...
set xlabel ""   font ""
set x2label ""   font ""
set xrange [ "05-30-2015 00:00:00" : "10-03-2015 00:00:00" ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Temperature, \312C"   font ""
set y2label ""   font ""
set yrange [ 14 : 28 ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
...
plot 'ts5109.out' using 1:8 title "Ice Harbor for unimpounded scenario" with lines lt 1, 'ts2015.out' using 1:8 title "Ice Harbor for impounded scenario" with lines lt 2, 'ts33.out' using 1:8 title "Lower Granite for unimpounded scenario" with lines lt 3, 'ts101.out' using 1:8 title "Lower Granite for impounded scenario" with lines lt 4, 20 title "" with lines lt 9
#    EOF
